...
for(var i = 1;i <= 10/*Number.MAX_SAFE_INTEGER*/;i++)
{
	...
	else
	{
		...
		var formatted_date =  current_datetime.getFullYear().toString() + ((current_datetime.getMonth() + 1) > 10 ? (current_datetime.getMonth() + 1).toString() : ('0'+(current_datetime.getMonth() + 1))) + current_datetime.getDate().toString();

	XLSX.writeFile(wb,formatted_date+".xlsx");	
	}
	var endTime = new Date();
	var totalTime = endTime - startTime;
	console.log('Time taken: ' + totalTime / 1000);
});
